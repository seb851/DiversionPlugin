...
void OpenAPIUserErrors::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUserErrors::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*InnerGeneratorOpenAPIObject, TEXT("errors"), Errors);
