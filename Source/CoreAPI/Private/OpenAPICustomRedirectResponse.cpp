...
#include "OpenAPICustomRedirectResponse.h"
...
void OpenAPICustomRedirectResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICustomRedirectResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
