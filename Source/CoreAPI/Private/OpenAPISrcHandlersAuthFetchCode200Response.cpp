...
void OpenAPISrcHandlersAuthFetchCode200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISrcHandlersAuthFetchCode200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*InnerGeneratorOpenAPIObject, TEXT("code"), Code);
