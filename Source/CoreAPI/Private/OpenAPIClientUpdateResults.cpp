...
void OpenAPIClientUpdateResults::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIClientUpdateResults::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*InnerGeneratorOpenAPIObject, TEXT("results"), Results);
