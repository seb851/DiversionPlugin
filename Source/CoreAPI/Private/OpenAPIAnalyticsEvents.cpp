...
void OpenAPIAnalyticsEvents::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAnalyticsEvents::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*InnerGeneratorOpenAPIObject, TEXT("events"), Events);
