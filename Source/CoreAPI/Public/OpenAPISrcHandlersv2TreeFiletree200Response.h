...
/*
 * OpenAPISrcHandlersv2TreeFiletree200Response
 *
 * 
 */
class COREAPI_API OpenAPISrcHandlersv2TreeFiletree200Response : public Model
{
public:
    virtual ~OpenAPISrcHandlersv2TreeFiletree200Response() {}
